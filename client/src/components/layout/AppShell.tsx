...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-muted/30 flex">
      ...
      <aside className="hidden md:flex w-[280px] flex-col border-r bg-white shadow-premium shrink-0 sticky top-0 h-screen overflow-y-auto">
        <div className="p-6 border-b bg-gradient-to-br from-white to-secondary/30 sticky top-0 bg-white/95 backdrop-blur-sm z-10">
        ...
        <div className="p-4 border-t bg-muted/30 space-y-2 sticky bottom-0 bg-muted/30 backdrop-blur-sm">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="md:hidden flex items-center justify-between p-3 border-b bg-white/80 backdrop-blur-xl sticky top-0 z-30 gap-2">
        ...
        {open && <div className="md:hidden border-b bg-white p-4 space-y-1 animate-fade-in sticky top-[57px] z-20 shadow-sm">
